...
const entries = [{
    ...
    },
    {
        ...
        datetime: '2021-04-21',
        title: 'V3.222',
        body: "<ul><li><li>Montagem de Estatísticas e Filtros Atendimento CRM</li><li>Relatórios e Interface Atendimento CRM para Cliente Lorentz</li></ul>",
    },
    {
        id: 'lorentz',
        categories: ['melhoria'],
    ...
    },
    {
        ...
        datetime: '2020-08-16',
        title: 'V3.218',
        body: "<ul><li>Habilitando módulo Webfone Lorentz </li></li><li>Pesquisa Satisfação URA</li><li>Relatórios de Satisfação URA	</li><ul><li>Acumulado	</li><li>Mensal	</li><li>Analítico</li></ul></ul>",
    },
    {
        id: 'lorentz',
        categories: ['melhoria'],
    ...
    },
    {
        ...
        datetime: '2020-06-09',
        title: 'V3.216',
        body: "<ul><li>Criando API de Integração </li></ul>",
    },
    {
        id: 'lorentz',
        categories: ['melhoria'],
